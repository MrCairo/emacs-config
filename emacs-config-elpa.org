#+title: Mitch's Emacs Configuration Using Standard package.el
#+author: Mitch Fisher
#+date: 2024-05-11
#+options: toc:4 h:4
#+startup: showall
...
- [[#general-configuration][General Configuration]]
  ...
  - [[#delight][Delight]]
  - [[#configure-paren-mode][Configure `paren` mode]]
...
- [[#dashboard][Dashboard]]
  - [[#value-of-dashboard-startup-banner-can-be][Value of dashboard-startup-banner can be:]]
    - [[#nil-to-display-no-banner][nil to display no banner]]
    ...
    - [[#1-2-or-3-which-displays-one-of-the-text-banners][1, 2 or 3 which displays one of the text banners]]
    - [[#pathtoyourimagegif]["path/to/your/image.gif",]]
    - [[#a-cons-of-pathtoyourimagepng--pathtoyourtexttxt][a cons of '("path/to/your/image.png" . "path/to/your/text.txt")]]
...
- [[#operational-systems][Operational Systems]]
  ...
  - [[#completion-handlers][Completion Handlers]]
    ...
    - [[#orderless][Orderless]]
    - [[#ivy-mode][IVY Mode]]
      - [[#ivy-rich-and-ivy-yasnippet][Ivy-rich and ivy-yasnippet]]
      - [[#swiper][Swiper]]
      - [[#counsel][Counsel]]
    ...
    - [[#vertico][Vertico]]
      - [[#vertico-support-packages][Vertico support packages]]
    - [[#marginalia][Marginalia]]
      - [[#icons-for-marginalia][Icons for Marginalia]]
    - [[#consult][Consult]]
    - [[#embark][Embark]]
    - [[#helm][Helm]]
      - [[#helm-wikipedia][helm wikipedia]]
  ...
  - [[#file-management][File Management]]
    - [[#dired][Dired]]
      - [[#key-binding-instructions][Key Binding Instructions]]
      - [[#use-gls-for-dired-on-macos][Use gls for dired on macOS]]
      - [[#all-the-icons---dired][All the icons - Dired]]
      - [[#files-to-open-eternally][Files to open eternally]]
      - [[#hide-dot-files][Hide dot files]]
      - [[#tab-to-open-subdirs][Tab to open subdirs]]
      - [[#large-number-of-files-handling][Large number of files handling]]
      - [[#single-window][Single Window]]
      - [[#special-ediff-with-dired][Special ediff with dired]]
        - [[#supporting-functions][Supporting Functions]]
        - [[#customized-variables][Customized Variables]]
        - [[#dired-and-ediff-configuration][Dired and ediff configuration]]
    - [[#treemacs][Treemacs]]
      - [[#treemacs-projectile][Treemacs Projectile]]
      - [[#treemacs-dired][Treemacs dired]]
      - [[#treemacs-persp][Treemacs Persp]]
      - [[#treemacs-tab-bar][Treemacs tab-bar]]
...
- [[#visuals][Visuals]]
  - [[#theme-list-and-selection][Theme List and Selection]]
    ...
    - [[#load-theme-function][Load Theme Function]]
      - [[#reset-spacious-padding][Reset spacious-padding]]
      - [[#load-theme-from-selector][Load Theme From Selector]]
  ...
  - [[#frame-and-font-setup][Frame and Font Setup]]
    ...
    - [[#track-selected-front-size][Track Selected Front Size]]
    - [[#handle-higher-rez-monitor][Handle higher-rez monitor.]]
      - [[#frame-font-selection][Frame font selection]]
        - [[#resolution-key-bindings][Resolution Key Bindings]]
        - [[#frame-support-functions][Frame support functions]]
        - [[#update-other-mode-fonts-if-needed][Update other mode fonts if needed]]
        - [[#select-display-font-and-optionally-recenter][Select Display Font and optionally Recenter]]
        - [[#early-display-resize][Early Display Resize]]
...
- [[#productivity][Productivity]]
  - [[#org-mode][Org Mode]]
    ...
    - [[#org-setup][Org Setup]]
      ...
      - [[#the-capture-templates-function][The capture-templates function]]
      - [[#org-todos][Org-Todos]]
      - [[#user-customized-faces][User customized faces]]
...
- [[#integrated-development-environments][Integrated Development Environments]]
  - [[#code-completion-and-handling][Code Completion and Handling]]
    ...
    - [[#language-server-protocol-lsp-mode][Language Server Protocol (lsp-mode)]]
      - [[#lsp-ui][LSP UI]]
      - [[#lsp-treemacs-integration][LSP Treemacs integration]]
      - [[#lsp-mode-hook-function][LSP mode hook function]]
      - [[#lsp-configuration-for-rust][LSP configuration for Rust]]
...
- [[#language-integration][Language Integration]]
  - [[#language-support-packages][Language Support Packages]]
    ...
    - [[#tree-sitter][Tree-sitter]]
      - [[#tree-sitter-support-functions][Tree-sitter-support functions]]
      - [[#the-main-tree-sitter-setup][The main Tree-sitter setup]]
  ...
  - [[#debug-support][Debug Support]]
    - [[#debug-adapter-protocol][Debug Adapter Protocol]]
      ...
      - [[#dap-package-for-ocaml][DAP Package for OCaml]]
      - [[#dap-package-for-python][DAP Package for Python]]
      - [[#dap-setup-for-rust-and-go][DAP Setup for Rust and Go]]
      - [[#dap-hydra][DAP Hydra]]
        - [[#dap-hydra-debug-functions][DAP Hydra Debug Functions]]
        - [[#dap-hydra-definition-function][DAP Hydra Definition Function]]
...
NOTE: For now, this is disabled since it's unused.
...
:properties:
:custom_id: configure-paren-mode
:visibility: folded
:end:
...
*** Track Selected Front Size
:properties:
:custom_id: track-selected-fonbt-size
:visibility: folded
:end:
...
:properties:
:custom_id: integrated-development-environments
:visibility: folded
:end:
