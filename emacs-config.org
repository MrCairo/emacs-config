...
Variables that hold dirtectory paths to where Emacs is to find and/or store it's files. Some variables can also be used for where the user will put their files as well.
:file-locations:
#+begin_src emacs-lisp
   ;;; ##########################################################################
...
:proportional-font-validator-and-defaults:
#+begin_src emacs-lisp
  ;;; ##########################################################################
...
Look for a proportional font that is available on the OS. If the actual default font isn't available, find another that will work instead.
:fixed-font-validator-and-defaults:
#+begin_src emacs-lisp
  ;;; ##########################################################################
...
*** Experimental Emacs Application Framework
#+begin_src emacs-lisp :tangle no
